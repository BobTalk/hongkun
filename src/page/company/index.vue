<template>
  ...
  <!--<div id="ap">-->
    <!--<div class="box">-->
      ...
      <!--&lt;!&ndash;<button @click="updateStcockChart" :disabled="!stockChart">更新数据范围</button>&ndash;&gt;-->
    <!--</div>-->
    <!--<div class="box">-->
      <!--<h3>-->
        <!--更多：-->
    ...
    <!--<div class="box">-->
      ...
      <!--&lt;!&ndash;<button @click="updateChart">更新图表</button>&ndash;&gt;-->
    <!--</div>-->
  <!--</div>-->
</template>
<script>
...
//  Highmaps(Highcharts);
//  import HighchartsComponent from '../group/highchartsComponent.vue';
  export default {
    name: 'ap',
    data() {
      return {
...
//    },
    methods: {
      changeCompanyName(){
        ...
        const reg = /(\(.*\))/g
        this.companyName = companyName && companyName.replace(reg, function(val){ return ""}) || "";
      },
//      updateChart() {
//        // 通过 refs 获取组件信息
